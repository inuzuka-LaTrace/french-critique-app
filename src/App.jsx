        ...
        <div className={`space-y-6 pb-8 ${fontSizeClasses[fontSize]}`}>
          {currentText.paragraphs.map((para) => (
            <div key={para.id} className={`${cardBgClass} rounded-lg shadow-lg p-6 border-2 ${borderClass} hover:shadow-2xl ${hoverBorderClass} transition-all`}>
              {showFrench && (
                <div className="mb-4">
                  <span className="text-xs font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-100 dark:bg-indigo-900 dark:bg-opacity-50 px-2 py-1 rounded">
                    原文 {para.id}
                  </span>
              ...
              {showOfficial && (
                <div className="mb-4 border-l-4 border-green-300 dark:border-green-700 pl-4">
                  <span className="text-xs font-semibold text-green-600 dark:text-green-400 bg-green-100 dark:bg-green-900 dark:bg-opacity-50 px-2 py-1 rounded">
                    公式訳
                  </span>
              ...
              {showUser && (
                <div className="border-l-4 border-purple-300 dark:border-purple-700 pl-4">
                  <span className="text-xs font-semibold text-purple-600 dark:text-purple-400 bg-purple-100 dark:bg-purple-900 dark:bg-opacity-50 px-2 py-1 rounded">
                    自分の訳
                  </span>
                    ...
                    <div className="mt-2">
                      ...
                      <div className="flex gap-2 mt-2">
                        <button
                          ...
                          className="px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 text-sm transition-all"
                        >
                          保存
                        </button>
                        <button
                          onClick={() => setEditingParagraph(null)}
                          className={`px-4 py-2 ${darkMode ? 'bg-gray-700' : 'bg-gray-300'} ${textClass} rounded hover:opacity-80 text-sm transition-all`}
                        >
                          キャンセル
                        </button>
                      </div>
